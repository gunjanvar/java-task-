...
public class Details {
	...
	public static void main(String[] args) {
		...
		for(int i = 1;i<=no;i++) {
			...
			Students stud = new Students(id,age,marks,name);
		...
		while(choice<5) {
			...
			case 1 : System.out.println("\n----Student List based on ID----");
					...
					for(Students s : studentList)//Displaying sorted List
			...
			case 2 : System.out.println("\n----Student List based on Age----");	
					...
					Collections.sort(studentList, new AgeComparators());// Sorting by comparing Age of students
					for(Students s : studentList)//Displaying sorted List
						System.out.println("Name : "+s.studentName +"  Id : " +s.studentId +"  Age : " +s.studentAge +"  Marks : " +s.studentMarks);
					break;
